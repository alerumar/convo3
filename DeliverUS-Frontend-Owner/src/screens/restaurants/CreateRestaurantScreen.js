...
export default function CreateRestaurantScreen ({ navigation }) {
  ...
  const initialRestaurantValues = { name: null, description: null, address: null, postalCode: null, url: null, shippingCosts: null, email: null, phone: null, restaurantCategoryId: null, isFavourite: false }
  const validationSchema = yup.object().shape({
    ...
    isFavourite: yup
      .boolean()
      .required('Favourite value is required')
  })
          ...
          <View style={{ alignItems: 'center' }}>
            <View style={{ width: '60%' }}>
              ...
              <Switch
                  ...
                  thumbColor={values.isFavourite ? GlobalStyles.brandSecondary : '#f4f3f4'}
                  value={values.isFavourite}
                  style={styles.switch}
                  onValueChange={value => setFieldValue('isFavourite', value)}
              />
